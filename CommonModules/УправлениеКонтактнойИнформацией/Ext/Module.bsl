...
Процедура СоздатьВТКонтактнаяИнформация(МенеджерВременныхТаблиц, МассивОбъектов, ТипыКИ = Неопределено, ВидыКИ = Неопределено, Дата = Неопределено) Экспорт
	...
	Иначе
		...
		//КоличествоВидовКИ = 3000000;
		//ТЗ.Колонки.Добавить("МассивОбъектов");
		//ТЗ.Колонки.Добавить("ТипыКИ");
		//ТЗ.Колонки.Добавить("ВидыКИ");
		//Для Сч = 1 По КоличествоВидовКИ Цикл
		//	НоваяСтрока = ТЗ.Добавить();
		//	НоваяСтрока.МассивОбъектов = 
