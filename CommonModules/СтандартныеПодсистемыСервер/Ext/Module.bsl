...
Функция ПараметрыРаботыПрограммы(ИмяКонстанты) Экспорт
	...
	Возврат СтандартныеПодсистемыПовтИсп.ПараметрыРаботыПрограммы(ИмяКонстанты);//4
...
Функция ДобавитьПараметрыРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	//	
	//	Если НеобходимоОбновлениеПараметровРаботыПрограммы() Тогда //2+
	...
	Параметры.Вставить("ОбработчикиКлиентскихСобытий", СтандартныеПодсистемыПовтИсп.ПараметрыПрограммныхСобытий().ОбработчикиСобытий.НаКлиенте);//2
...
Функция НеобходимоОбновлениеПараметровРаботыПрограммы(ВыполнитьЗагрузку = Истина) Экспорт
	...
	Попытка
		ПользователиСлужебныйПовтИсп.Параметры(); //3+
	Исключение
		ВыполнитьЗагрузку = Ложь;
		Возврат Истина;
	КонецПопытки;
