...
Функция ТЦПолучитьСписокДокументовДляПроведения()
	...
	|ГДЕ
	|	_ДемоСписаниеТоваров.Проведен
	|	И НЕ _ДемоСписаниеТоваров.ПометкаУдаления";
...
Процедура ТЦПровестиДокументНаСервере(ДокументСсылка)
	...
	ОценкаПроизводительностиКлиентСервер.ЗакончитьЗамерВремени("Проведение списания", ВремяНачала);
